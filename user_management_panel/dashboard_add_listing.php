...
<body onload="validate_user()">
  ...
  if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST["addList"]) && $_POST['listing_title']) {
    ...
    try {
      $insert_query = "INSERT INTO `listing` (`listing_id`, `listing_business_name`, `listing_business_category_id`, `listing_keyword`, `listing_tag`, `listing_cost`, `listing_business_sub_category_id`, `listing_description`, `listing_country_id`, `listing_pincode`, `listing_state_id`, `listing_location`, `listing_city_id`, `listing_image`,`listing_image2`,`listing_image3`, `listing_timestamp`, `listing_status_timestamp`, `listing_status`, `listing_permission`, `listing_owner_id`) VALUES (NULL, '$listing_title', '$category_id', '$keywords', '$tags', '$price', '$sub_category_id', '$listing_description', '1', '$pincode', '$state_id', '$address', '$city_id', '$logo_image1','$logo_image2','$logo_image3',  current_timestamp(),  current_timestamp(), 'Pending', 'Pending', '" . $_SESSION['slave_id'] . "')";
      ...
      <div class="utf_dashboard_content">
        ...
        if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST["addList"]) && $_POST['listing_title']) {
          if ($insert_result) {
            ...
            echo '<div class="row"> <div class="col-md-12"> <div class="notification success closeable margin-bottom-30"> <p> Listing Adding Failed </p> <a class="close" href="#"></a> </div> </div> </div>'; // echo ("<br> email shooting successfull <br>");
            // echo "Data insertion failed " . "<br>";
          }
        }
        ?>
