...
if (isset($_SESSION['is_phone_verified_for_register']) && isset($_SESSION['phone_for_register'])) {
  if ('' != $_SESSION['is_phone_verified_for_register'] && '' != $_SESSION['phone_for_register']) {
  } else {
          ...
          <div class="tab_content" id="tab2">
            <form enctype="multipart/form-data" method="post" class="register">
              ...
              <p class="utf_row_form utf_form_wide_block">
                <label for="register_user_type">User Type
              ...
              <p class="utf_row_form utf_form_wide_block">
                <label for="register_phone">phone no.
                  <input type="phone" class="input-text" onchange="validation_for_email_username_phone()" onload="validation_for_email_username_phone()" name="register_phone" id="register_phone" value="<?= $_SESSION['phone_for_register'] ?>" placeholder="phone no." disabled/>
                </label>
              </p>
