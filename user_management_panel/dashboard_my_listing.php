          ...
          <div class="col-lg-12 col-md-12">
            <div class="utf_dashboard_list_box margin-top-0">
              ...
              <ul class="paginationTable">
                ...
                $select_query = "SELECT * FROM `listing` WHERE `listing_owner_id` = $slave_id order by listing_timestamp desc";
                if ($filter != "") {
                  $select_query = "SELECT * FROM `listing` WHERE `listing_owner_id` = $slave_id AND `listing_status` LIKE '$filter' order by listing_timestamp desc";
                }
                $select_result = mysqli_query($connect, $select_query);
