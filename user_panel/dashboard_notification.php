            ...
            <div class="utf_dashboard_list_box margin-top-0">
              ...
              <div class="utf_user_messages_block">
                <ul class="paginationTable">
                  ...
                  if ($select_interaction_result && $select_interaction_num > 0) {
                      ...
                      if ($on_listing_id != '' && $on_listing_id != '0') {
                        ...
                        if ($select_interaction_on_listing_id_num > 0) {
                          while ($row_for_interaction_on_listing_id = mysqli_fetch_assoc($select_interaction_on_listing_id_result)) {
                            $interaction_listing_title = $row_for_interaction_on_listing_id['listing_business_name'];
                  ...
                  ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Status of your Listing <b><?= $interaction_listing_title ?></b> is Active <?php if ($seen == '1') {
                                                                                                } else {
                                                                                                  echo '<i>New</i>';
                                                                                                } ?></h5>
                           ...
                           <div class="bg-c1 ">
                            <img src='../images/<?= $interaction_listing_image ?>' style="max-height:32px;width:auto;background-color:#e8e800;"></img>
                          </div>
                        </li>
                      <?php
                      }
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Status of your Listing <b><?= $interaction_listing_title ?></b> is Pending <?php if ($seen == '1') {
                                                                                                  } else {
                                                                                                    echo '<i>New</i>';
                                                                                                  } ?></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Status of your Listing <b><?= $interaction_listing_title ?></b> is Expired <?php if ($seen == '1') {
                                                                                                  } else {
                                                                                                    echo '<i>New</i>';
                                                                                                  } ?></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Request for your Listing <b><?= $interaction_listing_title ?></b> is Approved <?php if ($seen == '1') {
                                                                                                  } else {
                                                                                                    echo '<i>New</i>';
                                                                                                  } ?></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Request for your Listing <b><?= $interaction_listing_title ?></b> is Pending <?php if ($seen == '1') {
                                                                                                  } else {
                                                                                                    echo '<i>New</i>';
                                                                                                  } ?></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
                      ...
                      ?>
                        <li class="tableItem dashboard_notifi_item ">
                          ...
                          <div class="content utf_message_headline_item utf_message_headline_text" style="margin-left:0px;">
                            <h5>Request for your Listing <b><?= $interaction_listing_title ?></b> is Rejected <?php if ($seen == '1') {
                                                                                                  } else {
                                                                                                    echo '<i>New</i>';
                                                                                                  } ?></h5>
                            <span class="date"><i class="fa fa-clock-o"></i> <?= $interaction_timestamp ?> </span>
