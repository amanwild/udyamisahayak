          ...
          <div class="col-md-12">
            <div class="row">
              ...
              ?>
                  ...
                  <div class="utf_listing_item-container list-layout" onclick="update_enquery(<?= $row_for_listing['listing_id'] ?>)">
                    <a class="utf_listing_item">
                      ...
                      <!-- <?= $row_for_listing['listing_cost'] ?> Rs</span>
                        ...
                        <div class="" style="color:black">
                          <li class=" dashboard_notifi_item ">
                            ...
                            <div class="content utf_message_headline_item utf_message_headline_text" style="display:flex;flex-direction: column;margin:auto;margin-left:0px;">
                              ...
                              ?>
                                  <span style="margin:0px;"<?php if (isset($_SESSION['user_id']) || isset($_SESSION['enquery_id'])) {
                                        } else {
                              ...
                              <!-- <span><i class="fa fa-building"></i>Company Name : <?= $row_for_listing['listing_firm_name'] ?></span>
                          <span><i class="fa fa-map-marker"></i>Location : <?= $row_for_listing['listing_location'] ?></span>
                          <span><i class="fa fa-phone"></i>Phone No.: (+91) <?= $row_for_listing['listing_phone'] ?></span>
                          <span><i class="fa fa-link"></i>Email : <?= $row_for_listing['listing_email'] ?></span> -->
                              ...
                              <!-- <span><i class="fa fa-list"></i>Sub Category : <?= $row_for_listing['sub_category_name'] ?></span> -->


                              <!-- <span><i class="fa fa-link"></i>Website : <?= $row_for_listing['listing_website'] ?></span> -->
                            ...
                            <div class="bg-c1 ">
                            <button class="button border sign-in " style="margin-bottom:29px;">Enquiry Now</button>
