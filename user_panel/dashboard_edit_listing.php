        ...
        if (isset($_GET['edit_listing_listing_id'])) {
          ...
          if (($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_POST["updateList"]) && isset($_POST['listing_id']))) {
            ...
            $filter = array(
              ...
              'listing_image' => $logo_image1,
              'listing_image2' => $logo_image2,
              'listing_image3' => $logo_image3,
                    ...
                    <div class="add_utf_listing_section margin-top-45" validate>
                      ...
                      <div class="row with-forms">
                        <div class="col-md-6">
                          ...
                          <input type="text" name="listing_title" id="listing_title" value="<?= $listing_title ?>" />
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="utf_submit_section">
                        <div class="row with-forms">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="input-text" name="address" id="address" value="<?= $listing_adderess  ?>" />
                          </div>
